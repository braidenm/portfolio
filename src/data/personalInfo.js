...
export const certifications = {
  javaOracle: {
    name: 'Java Oracle Certified Programmer I',
    url: 'https://education.oracle.com/product/trackp_333',
    topics: [
      'Java 8 Date And Time API',
      'Lambda Expressions',
      'Collections Framework',
      'Exception Handling',
      'Object Oriented Pillars and Structure',
    ],
  },
  comptia: {
    name: 'CompTIA Project+',
    url: 'https://certification.comptia.org/certifications/project',
    topics: [
